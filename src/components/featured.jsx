      ...
      <Container>
        <div className="text-center mb-4">
          ...
          <p className="subtitle">
            “Eazy-Autos Special Picks for Seamless City Driving.”
          </p>
        </div>
            ...
            <Col xs={12} md={6} lg={4} key={index}>
              <Card className="car-card h-100 text-center shadow-sm">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <h6 className="text-muted" style={{ marginLeft: 57 }}>
                    {car.title}{" "}
                    <span className="float-end price">{car.price}</span>
                  </h6>
                  <hr />
                  ...
                  <div className="mt-auto">
                    <Button
                      ...
                      className="rounded-pill px-5 explore-btn"
